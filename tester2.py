...
REQUIRED_DEFNS = [
    'gift_recommender', 'calculate_student_score', 'calculate_letter_grade', 'is_discount_applicable',
    'book_price']
...
class AllTests (unittest.TestCase):
    ############################################################################
    '''gift_recommender tests -- x1 pts each == 13 points'''

    def test_gift_recommender_1(self):
        self.assertEqual(gift_recommender('jewelry', 99.5), 'ring')

    def test_gift_recommender_2(self):
        self.assertEqual(gift_recommender('jewelry', 500.00), 'necklace')

    def test_gift_recommender_3(self):
        self.assertEqual(gift_recommender('jewelry', 1550.0), 'bracelet')

    def test_gift_recommender_4(self):
        self.assertEqual(gift_recommender('jewelry', 999.1), 'necklace')

    def test_gift_recommender_5(self):
        self.assertEqual(gift_recommender('clothing', 20.1), 'tops')

    def test_gift_recommender_6(self):
        self.assertEqual(gift_recommender('clothing', 100.0), 'shoes')

    def test_gift_recommender_7(self):
        self.assertEqual(gift_recommender('clothing', 100.001), 'suits')

    def test_gift_recommender_8(self):
        self.assertEqual(gift_recommender('electronics', 200.05), 'smart watch')

    def test_gift_recommender_9(self):
        self.assertEqual(gift_recommender('electronics', 120), 'headphone')

    def test_gift_recommender_10(self):
        self.assertEqual(gift_recommender('electronics', 99.9), 'gaming earbuds')

    def test_gift_recommender_11(self):
        self.assertEqual(gift_recommender('clothing', 25.5), 'jackets')

    def test_gift_recommender_12(self):
        self.assertEqual(gift_recommender('clothing', 25), 'tops')

    def test_gift_recommender_13(self):
        self.assertEqual(gift_recommender('', 50.0), 'decorative gifts!')
    ############################################################################

    '''calculate_student_score tests -- x1 pts each == 7 points'''

    def test_calculate_student_score_1(self):
        self.assertEqual(calculate_student_score(100.0, 90.87, 95.00), 95.761)

    def test_calculate_student_score_2(self):
        self.assertEqual(calculate_student_score(50.0, 70.9, 0.0), 0.0)

    def test_calculate_student_score_3(self):
        self.assertEqual(calculate_student_score(80.0, 0.0, 50.0), 62.0)

    def test_calculate_student_score_4(self):
        self.assertEqual(calculate_student_score(65.0, 90.0, 100.0), 83.0)

    def test_calculate_student_score_5(self):
        self.assertEqual(calculate_student_score(25.0, 51.2, 100.0), 55.36)

    def test_calculate_student_score_6(self):
        self.assertEqual(calculate_student_score(0.0, 0.0, 100), 60.0)

    def test_calculate_student_score_7(self):
        self.assertEqual(calculate_student_score(100.0, 0.0, 100.0), 100.0)

    ############################################################################
    '''calculate_letter_grade tests -- x1 pts each == 6 points'''

    def test_calculate_letter_grade_1(self):
        self.assertEqual(calculate_letter_grade(90), 'B')

    def test_calculate_letter_grade_2(self):
        self.assertEqual(calculate_letter_grade(59.9), 'F')

    def test_calculate_letter_grade_3(self):
        self.assertEqual(calculate_letter_grade(73), 'C')

    def test_calculate_letter_grade_4(self):
        self.assertEqual(calculate_letter_grade(62.1), 'D')

    def test_calculate_letter_grade_5(self):
        self.assertEqual(calculate_letter_grade(80), 'C')

    def test_calculate_letter_grade_6(self):
        self.assertEqual(calculate_letter_grade(90.001), 'A')

    ############################################################################
    '''is_discount_applicable tests -- x1 pts each == 5 points'''

    def test_is_discount_applicable_1(self):
        self.assertEqual(is_discount_applicable(60, False, "CS", 3.5), True)

    def test_is_discount_applicable_2(self):
        self.assertEqual(is_discount_applicable(37, True, "", 0.0), True)

    def test_is_discount_applicable_3(self):
        self.assertEqual(is_discount_applicable(59, False, "CS", 3.6), False)

    def test_is_discount_applicable_4(self):
        self.assertEqual(is_discount_applicable(24, False, "IST", 3.9), False)

    def test_is_discount_applicable_5(self):
        self.assertEqual(is_discount_applicable(33, False, "CS", 3.9), True)

    ############################################################################
    '''book_price tests -- x1 pts each == 9 points'''

    def test_book_price_1(self):
        self.assertEqual(book_price(79, True, "CS", 3.9, "mystery"), 10.0)

    def test_book_price_2(self):
        self.assertEqual(book_price(21, True, "ME", 3.9, "comic"), 12.0)

    def test_book_price_3(self):
        self.assertEqual(book_price(23, False, "CS", 3.71, "novel"), 12.0)

    def test_book_price_4(self):
        self.assertEqual(book_price(60, False, "", 0.0, "fiction"), 24.0)

    def test_book_price_5(self):
        self.assertEqual(book_price(36, False, "", 4.0, "novel"), 20.0)

    def test_book_price_6(self):
        self.assertEqual(book_price(36, True, "CEIE", 4.0, "science"), 30.0)

    def test_book_price_7(self):
        self.assertEqual(book_price(41, False, "Cyber", 3.7, "horror"), 20.0)

    def test_book_price_8(self):
        self.assertEqual(book_price(70, False, "", 0.0, "kids"), 0.0)

    def test_book_price_9(self):
        self.assertEqual(book_price(43, False, "IST", 3.0, "adventure"), 0.0)
